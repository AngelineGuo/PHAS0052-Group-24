...
fasta_files_dir = os.path.join(base_dir, "..", "Files", "fasta")  # fasta files directory
fasta_files = []
...
your_email = "example@gmail.com" # Use personal email and add filter to delete the mails  
